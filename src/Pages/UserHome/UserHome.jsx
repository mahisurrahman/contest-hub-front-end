    ...
    <Fade cascade damping={0.1}>
      <div className="text-white rounded-lg font-font-poppins px-4 py-2">
        ...
        <div className="mt-10 border-2 rounded-lg px-4 py-2 flex flex-col gap-4">
            ...
            <h1 className="font-bold text-xl ">Win Percentage : <span className="font-light"> 0%</span></h1>
            <h1 className="font-bold text-xl ">Participated in Contest : <span className="font-light"> 0%</span></h1>
